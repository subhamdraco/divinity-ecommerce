                ...
                <div className='row px-2'>
                    <div className='col'>
                        <div className='box'>
                            ...
                            <div className='shopnowbutton'><Link to="/products"><Button variant='contained'>Shop Now</Button></Link></div>
                        </div>
                    </div>

                    <div className='col'>
                        <div className='box'>
                            <h5>Products crafted with <br />care and tested <br />for safety</h5>
