...
import './Index.css';
import HomesliderImg1 from '../../../assets/images/slider-1.png';
                ...
                <div className="shopnowbuttons">
                    <ul className="list list-inline">
                        <li className="list list-inline-item playfair">
                            <Button variant="contained"><Link to="/reshu">Explore Reshu</Link></Button>
                        </li>
                        <li className="list list-inline-item titan">
                            <Button variant="outlined"><Link to="/titan">Explore Titan Core</Link></Button>
                        </li>
                        <li className="list list-inline-item">
                            <Button variant="contained"><Link to="/shop">Shop Now</Link></Button>
                        </li>
                    </ul>
                </div>
            </div>
